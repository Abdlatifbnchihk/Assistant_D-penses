...
Allows users to edit receipt source text and manage individual expenses (add, edit, delete) on processed receipts. Provides manual correction capabilities when AI extraction produces errors.
